...
<body class="nav-md" style="background-color: #5353ec;">

    <div class="container body">
    <div class="main_container">
        <div class="col-md-3 left_col">

        <div class="left_col scroll-view" style="background-color: #5353ec;">

            <!-- Website Logo -->
            <div class="navbar nav_title" style="border: 0; background-color: #5353ec;">
            <a href="index.html" class="site_title"><i class="fa fa-book"></i> <span>DIGITALLIBRARY</span></a>
            </div>
            <!-- /Website Logo -->
                    ...
                    <ul class="nav side-menu">
                        ...
                        <ul class="nav child_menu">
                            ...
                            <?php if($_SESSION['login']['Level'] == 'administrator') { 
                                ?>
                                <li class="<?= $pages == 'user' ? 'current-page' : ''?>"><a href="index.php?page=user">User</a></li>
                                <li class="<?= $pages == 'status-peminjaman' ? 'current-page' : ''?>"><a href="index.php?page=status-peminjaman">Status Peminjaman</a></li>
                            </li>
                             <?php
                            }
                            ?>
            ...
            <!-- /menu footer buttons -->
            <div class="sidebar-footer hidden-small" style="background-color: #e3f2fd;">
                <a data-toggle="tooltip" data-placement="top" title="FullScreen" style="width: 50%; background-color: #e3f2fd;">
                    <span class="glyphicon glyphicon-fullscreen" aria-hidden="true"></span>
                </a>
                <a data-toggle="tooltip" data-placement="top" title="Logout" href="../logout.php" style="width: 50%; background-color: #e3f2fd;">
        ...
        <!-- top navigation -->
        <div class="top_nav">
        <div class="nav_menu" style="background-color :#e3f2fd;">
