...
class Book extends Connection{
    ...
    public function edit($id) {
        ...
        $q2 = mysqli_query($this->conn, "SELECT kategoribuku.NamaKategori, kategoribuku.KategoriID, kategoribuku_relasi.KategoriBukuID, kategoribuku_relasi.BukuID FROM kategoribuku_relasi LEFT JOIN kategoribuku ON kategoribuku.KategoriID = kategoribuku_relasi.KategoriID WHERE kategoribuku_relasi.BukuID='$id'");
    ...
    public function updateCategory($kategori, $buku){
        $check = mysqli_query($this->conn, "SELECT KategoriID, BukuID FROM kategoribuku_relasi WHERE KategoriID='$kategori' AND BukuID='$buku'");
        ...
        exit(header("location:?page=buku&act=edit&id=$buku"));
