...
<body class="login" style="background-image:url('assets/image/background.png')">
...
<?php endif; ?>
    ...
    <div class="login_wrapper">
        ...
        <section class="login_content">
           ...
           <h3 class="text-center font-weight-light my-4" style="color:black;">Login Perpustakaan Digital</h3>
            <div>
